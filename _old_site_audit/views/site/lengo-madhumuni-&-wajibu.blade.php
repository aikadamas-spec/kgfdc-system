...
<div class="w-[1500px] mx-auto my-10 bg-white rounded-[2rem] p-10 shadow-[0_10px_40px_rgba(0,0,0,0.08)] font-sans">
    
    <!-- Content Section -->
    <h2 class="text-2xl font-bold text-center mb-3">Lengo,Madhumuni na Wajibu</h2>
    <hr>
    <h2 class="text-2xl font-bold text-center mb-3 ">
        Lengo la kuanzishwa kigamboni FDC:
    </h2>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        Lengo la kuanzishwa kigamboni FDC ni kujenga uwezo wa jamii kiuchumi kwa kuwawezesha wananchi kubuni na kuendesha miradi ya kujitegemea yenye tija ili kuinua kipato na kujiletea maendeleo yao na ya Taifa kwa jumla.
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        Lengo hili litafikiwa kwa kuweka mifumo na taratibu nyumbufu, zitakazowezesha kupata idadi kubwa ya watanzania walioelimika na wanaopenda kuelimika zaidi ili kutimiza malengo ya maendeleo ya Taifa letu kwa kukuza Uchumi. 
    </p>
    <hr>
     <h2 class="text-2xl text-center leading-relaxed mb-6 font-bold">
        Madhumuni ya Kigamboni FDC:
    </h2>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        i.	Kuwawezesha wananchi kujiendeleza na kujitolea kuchangi katika maendeleo ya Taifa kiuchumi, kijamii, kisiasa na kiutamaduni;
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        ii.	Kuwawezesha wananchi kubaini matatizo na mahitaji yao halisi ili kuyapatia ufumbuzi wa kudumu katika maeneo yao:    
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        iii. Kupunguza umaskini kwa kuwezesha jamii hasa vijana kupanua upeo wa uelewa, marifa na stadi mbalimbali katika viwanda, kilimo, maadili, demokrasia, utawala bora, sheria na mwenendo wa soko huria    
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        iv.	Kuchochea maendeleo ya wananchi mahali walipo kupitia elimu kwa vitendo kwa kutumia technolojia sahihi na miradi mbalimbali inayoendeshwa vyuoni;    </p>

    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        v.	Kuimarisha ushirikishwaji wa wananchi na vikundi vyenye mahitaji maalum ya mafunzo;
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        vi.	Kushirikiana na wananchi katika kuimarisha na kudumisha utamaduni wa Taifa na kupiga vita mila na desturi zisizofaa za ndani na nnje ya nchi;    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        vii. Kuiwezesha jamii kuelewa umuhimu wa hifadhi na matumizi bora ya mazingira; na
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        viii. Kuelimisha jamii namna ya kujikinga na majanga mbalimbali yanayojitokeza;matumizi ya madawa ya kulevya;na magonjwa ya milipuko, kuambukizwa na yasiyombukizwa    
    </p>
    <hr>
    <h2 class="text-2xl text-center leading-relaxed mb-6 font-bold">
        Majukumu ya Kigamboni FDC:
    </h2>
     <p class="text-gray-500 text-xl leading-relaxed mb-6">
        i. Kutafsiri kwa vitendo madhumuni ya vyuo vya maendeleo ya wananchi kulingana na jamii inayozunguka chuo
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        ii.	Kutoa maunzo yenye kuogeza maarifa, stadi n mbinu mbalimbali za kutatua changamoto za wananchi kwa kuzingatia technolojia, rasilimali zilizopo na mahitaji ya soko ili waweze kujilete maendeleo;
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        iii. Kubuni na kufanya uchambuzi yakinifu,Pamoja na kuendesha miradi ya uzalisaji mali na kutoa huduma zitakazokuwa na tija kwa jamii;
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        iv. Kubuni na kuweka mikakati ya kusaidia jamii husika kutumia elimu na ujuzi wanaoupata kuanzisha na kuendeleza viwanda vidogo kwa kushirikiana na taasisi,watu binafsi na vikundi mbalimbali;
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        v. Kuandaa na kuendesha programu zitakazoinua viwango vya fikra, maarifa na stadi za wananchi kuhusu mazingira yanayowazunguka na ya nnje;    
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        vi.	Kuwa vituo vya kufundishia nje ya Mfumo Rasmi na Elimu ya Watu Wazima;    
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        vii. Kutengeneza na kusambaza technolojia na nyenzo za kurahisisha kazi kwa jamii;    
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        viii. Kuanzisha Vituo Atamizi vya Ujuzi, Ujasiliamali na Technolojia ya Habari na Mawasiliano;    
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        ix. Kushirikiana na kubadilishana uzoefu na asasi na mashirika mbalimbali yanayotoa mafunzo, utaalam na rasilimali nyinginezo za kuwaendeleza wananchi    
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        x. Kubaini mila zinazoleta vikwazo katika maendeleo na kutoa elimu ya kuondokana na mila hizo kwa jamii    
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        xi.	Kuendesha program mbalimbali za hifadhi ya mazigira kwa wananchi zinazohusu matumizi bora ya adhri kwa kuzingatia kanuni za kilimo na ufugaji bora, uandaji miti na maua, utunzaji wa vyanzo vya maji n.k;    
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        xii. Kuwashirikisha wananchi katika mijadala inayohusu masuala ya jinsia, haki za binadamu na utawala bora;    
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        xiii. Kubuni mikakati ya namna ya kuwafuatilia wahitimu kwa nia ya kupima viwango vya taathira vilivyofikiwa kutokana na mafunzo yanayotolewa vyuoni n kutumia matokeo ya upimaji huo kuboresha mitaala na kuweka mikakati ya utekelezaji; na    
    </p>
    <p class="text-gray-500 text-xl leading-relaxed mb-6">
        xiv. Kushirikiana na asasi nyngine za srikali, madhehebu ya dini na mashirika yasiyo ya kiserikalia wananchi katika kubuni na kutekeleza programu na miradi Madhubuti ya kutokomeza rushwa; mjanga mbalimbali;matumizi ya madawa ya kulevya;na magonjwa ya mlipuko, kuambukizwa na yasiyoambukizwa.     
    </p>
    </div>
...
Matengenezo ya mifumo ya maji majumbani na viwandani</p>
    ...
    <!-- Updated Floating Sidebar with Tooltips -->
    <div class="floating-social">
       
        <!-- Tafuta/Support -->
        <a href="#" class="social-btn" data-tooltip="Tafuta">
            <i class="fas fa-headset"></i>
            <span class="social-tooltip"></span>
        </a>
        
        <!-- Chat -->
        <a href="#" class="social-btn" data-tooltip="Chat">
            <i class="fas fa-comment"></i>
            <span class="social-tooltip"></span>
        </a>
        
        <!-- Kiswahili (TZ) -->
        <a href="#" class="social-btn" data-tooltip="Kiswahili">
            <img src="{{ asset('tzflag.webp') }}" alt="Kiswahili" class="h-9 w-9 object-contain">
            <span class="social-tooltip"></span>
        </a>
        
        <!-- English (GB) -->
        <a href="#" class="social-btn" data-tooltip="English">
