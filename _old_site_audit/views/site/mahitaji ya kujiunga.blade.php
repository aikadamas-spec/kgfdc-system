...
<div class="w-[1500px] mx-auto my-10 bg-white rounded-[2rem] p-10 shadow-[0_10px_40px_rgba(0,0,0,0.08)] font-sans">
    ...
    <!-- Content Section -->
    <h2 class="text-4xl font-bold text-center mb-3">Mahitaji ya Kujiunga</h2>
       <p class="text-xl text-center text-gray-500 text-sm leading-relaxed mb-6">
        Mahitaji ya kujiunga yanategemea aina mbalimbali za kozi zinazotolewa chuoni:
    </p>
<div class="tabs-container">
  ...
  <div class="tab-content">
    <div class="tab-content-item" style="display: block;">
      <p>Mahitaji kujiunga Kozi ndefu</p>
    </div>
    <div class="tab-content-item" style="display: none;">
      <p>Mahitaji kujiunga Kozi fupi</p>
    </div>
  </div>
</div>
</div>
