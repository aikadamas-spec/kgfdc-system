...
<div class="w-[1500px] mx-auto my-10 bg-white rounded-[2rem] p-10 shadow-[0_10px_40px_rgba(0,0,0,0.08)] font-sans">
    ...
    <!-- Content Section -->
    <h2 class="text-4xl font-bold text-center mb-3">Sera ya Faragha</h2>
    <p class="text-xl text-gray-500 text-justify leading-relaxed mb-6">
        Chuo hiki kilianzishwa kwenye Jengo la Arnautoglu lililopo eneo la Mnazi mmoja Wilaya ya Ilala Jijini Dar es salaam. 
    </p>
    <p class="text-xl text-gray-500 text-justify leading-relaxed mb-6">
        Jengo hilo lilikuwa mali ya Mgiriki aliyekuwa akiitwa George Arnautoglu. Katika miaka ya 70, George Arnautoglu alilikabidhi jingo hilo kwa Rais wa Awamuya Kwanza wa Jamhuri ya Muungano wa Tanzania  Mwalimu Julius K. Nyerere. Na mnamo mwaka 1976  Chuo cha Maendeleo ya Wananchi Arnautoglu kilianzishwa kwenye jingo hilo nakuendelea hadi mwaka 2020. Na ilipofikamwaka 2020, Wizara ya Elimu Sayansi na Teknolojia iliamua kukipanua chuo ilikutanua shughuli za mafunzo, hivyo Wizara ilipata Eneo kubwa katika Halmashauri ya Wilaya ya Kigamboni. Na kwaushirikiano mkubwa wa Ofisi za Mkuu wa Wilaya ya KigambonipamojanaMkurugenziwaManispaaKigambonichuokilipewaeneo la ekari 14.5.  
    </p>

    <p class="text-xl text-gray-500 text-justify leading-relaxed mb-6">
        Baada ya kupata eneo hilo Mradi wa ujenzi wa chuo cha Maendeleo ya Wananchi Kigamboni ulianza Desemba 2021.  Mradi huu ulihusisha ujenzi wa majengo 14 na Ununuzi wasamani katika majengo yote.   
    </p>

    <p class="text-xl text-gray-500 text-justify leading-relaxed mb-6">
        Wakati huohuo Wananchi wa Kigamboni kupitia Mbunge wao Hayati Dr. Faustine Ndugulile walipendekeza jina la chou libadilike kutoka Arnautoglu kuwa Chuo cha maendeleo ya wananchi Kigamboni ambapo oktoba 2023 Wizara ya Elimu Sayansi na Teknolojia iliridhia ombi hilo.   
    </p>
    <p class="text-xl text-gray-500 text-justify leading-relaxed mb-6">
    Chuo cha Maendeleo ya Wananchi Kigamboni kinaendelea kutoa mafunzo chini ya mfumo wa NACTVET na kimesajiliwa kwa namba REG/NACTVET/1123.
    </p>
</div>
            ...
            <div class="border-t border-gray-800 py-6">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div class="flex space-x-6 mt-4 md:mt-0">
                        <a href="{{ url ('/sera-ya-faragha') }}" class="text-gray-400 hover:text-white text-sm transition">Sera ya faragha</a>
