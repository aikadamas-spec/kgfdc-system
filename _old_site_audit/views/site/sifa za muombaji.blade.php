...
.tabs-container {
  background-color: #4ca8cd; /* Blue background from your image */
  padding: 20px;
}
...
.tabs li {
  padding: 10px 20px;
  background-color: #5c9ccc; /* Inactive tab color */
  border: 1px solid #285e8e;
  border-bottom: none; /* Initially hide bottom border */
  cursor: pointer;
}

/* The "White Background" Active Tab */
.tabs li.active {
  background-color: white; /* Matches content area */
  color: #333;
  position: relative;
  top: 1px; /* Shifts tab down 1px to overlap the content border */
  border-bottom: 1px solid white; /* Effectively hides the line */
...
<div class="w-[1500px] mx-auto my-10 bg-white rounded-[2rem] p-10 shadow-[0_10px_40px_rgba(0,0,0,0.08)] font-sans">
    ...
    <!-- Content Section -->
    <h2 class="text-4xl font-bold text-center mb-3">Sifa za Muombaji</h2>
    <div class="tabs-container">
  <!-- Tab Headers -->
  <ul class="tabs">
    <li class="active text-xl" >KOZI NDEFU</li>
    <li class="text-xl">KOZI FUPI</li>
  </ul>

  <!-- Tab Content Area -->
  <div class="tab-content">
    <div class="tab-content-item" style="display: block;">
      <p class="text-xl">Awe na umri kuanzia miaka 15 nakuendelea</p>
      <p class="text-xl">Awe amemaliza kidato cha nne na kuendelea</p>
    </div>
    <div class="tab-content-item" style="display: none;">
      <p class="font-bold text-xl">i) FE – Folk Education: Hawa ni wanachuo wanaosoma kwa mjibu wa mwongozo wa mafunzo wa vyuo vya maendeleo ya wananchi.</p>
      <p class="text-xl">Umri wowote</p>
      <p class="text-xl">Awe anajua au hajui kusoma na kuandika</p>
      <p class="font-bold text-xl">ii) Kozi ya miezi 6</p>
      <p class="text-xl">Umri wowote</p>
      <p class="text-xl">Awe anajua au hajui kusoma na kuandika</p>
      <p class="text-xl">Awe amemaliza au hakumaliza shule ya msingi, sekondari n.k.</p>
      <p class="font-bold text-xl">iii) Uanagenzi.</p>
      <p class="text-xl">Hawa ni washiriki wanaoletwa na Ofisi ya Waziri Mkuu na mara nyingi husoma muda wa miezi 8 </p>
    </div>
  </div>
</div>
...
<script>
        ...
        tabs.forEach((tab, index) => {
            tab.addEventListener('click', () => {
                ...
                // 3. Hide all content items
                contents.forEach(content => {
                    content.style.display = 'none';
                });

                // 4. Show the content item that matches the tab index
                if(contents[index]) {
