...
<div class="max-w-4xl mx-auto">
    ...
    <h2 class="text-4xl font-bold text-center mb-4">
        {{ __('messages.long_courses_page_title') }}
    </h2>

    <p class="text-xl text-gray-500 text-justify leading-relaxed mb-10">
        {{ __('messages.long_courses_intro') }}
    </p>
    ...
    <div class="bg-blue-50 border border-blue-100 rounded-2xl p-6 mb-10">
        <h3 class="text-xl font-bold text-gray-700 mb-3 flex items-center gap-2">
            ...
            {{ __('messages.long_courses_qualifications_title') }}
        </h3>
        <p class="text-gray-600 leading-relaxed">
            {{ __('messages.long_courses_qualifications') }}
        </p>
    </div>

    {{-- Course List --}}
    <h3 class="text-2xl font-bold text-gray-700 mb-6">
        {{ __('messages.long_courses_list_title') }}
    </h3>

    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
        @foreach(__('messages.long_courses_list') as $course)
