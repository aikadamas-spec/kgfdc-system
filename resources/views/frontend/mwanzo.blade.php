...
<body class="font-sans text-gray-800">
    ...
    <div class="slider">
        ...
        <div class="slide bg-cover bg-center"
            style="background-image: url('{{ asset('frontend_assets/img/kgfdc.webp') }}');">
            <div class="hero-gradient"></div>
        </div>

        <div class="slide bg-cover bg-center"
            style="background-image: url('{{ asset('frontend_assets/img/ushonaji.webp') }}');">
            <div class="hero-gradient"></div>
        </div>

        <div class="slide bg-cover bg-center"
            style="background-image: url('{{ asset('frontend_assets/img/ziara1.webp') }}');">
            <div class="hero-gradient"></div>
        </div>
   
        <div class="slide bg-cover bg-center"
            style="background-image: url('{{ asset('frontend_assets/img/ziara2.webp') }}');">
            <div class="hero-gradient"></div>
        </div>

        <div class="relative z-10 container mx-auto px-4 h-full flex items-center">
            <div class="max-w-3xl">
                <div class="floating-label inline-block bg-light-blue/90 backdrop-blur-sm text-white px-5 py-2 rounded-full text-sm font-medium mb-6 border border-white/20">
                    <i class="fas fa-award mr-2"></i>{{ __('messages.hero_badge') }}
                </div>
                <h1 class="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
                    {{ __('messages.hero_title_line1') }} <span class="text-[#FAEE03]">{{ __('messages.hero_title_highlight') }}</span>
                </h1>
                <div class="w-full max-w-4xl bg-black/40 border-4 border-[#4ca8cd] rounded-2xl p-8 text-white drop-shadow-lg mb-6">
                    <p class="text-lg">{{ __('messages.hero_body') }}</p>
                </div>

                <div class="flex flex-wrap gap-4">
                    <a href="#Featured" class="bg-light-blue text-white px-8 py-4 rounded-lg font-semibold hover:bg-ocean-blue transition inline-flex items-center shadow-lg hover:shadow-xl">
                        {{ __('messages.hero_btn_programs') }} <i class="fas fa-arrow-right ml-2"></i>
                    </a>
                    <a href="#" class="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-gray-900 transition inline-flex items-center">
                        <i class="fas fa-play-circle mr-2"></i> {{ __('messages.hero_btn_video') }}
                    </a>
                </div>
                ...
                <div class="mt-10 flex items-center gap-8">
                    <div class="flex items-center gap-2 text-white/80">
                        <i class="fas fa-check-circle text-light-blue"></i>
                        <span class="text-sm">{{ __('messages.hero_badge_nacte') }}</span>
                    </div>
                    <div class="flex items-center gap-2 text-white/80">
                        <i class="fas fa-check-circle text-light-blue"></i>
                        <span class="text-sm">{{ __('messages.hero_badge_veta') }}</span>
                    </div>
                    <div class="flex items-center gap-2 text-white/80">
                        <i class="fas fa-check-circle text-light-blue"></i>
                        <span class="text-sm">{{ __('messages.hero_badge_career') }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2">
            <a href="#products" class="animate-bounce flex flex-col items-center text-white/60 hover:text-white transition">
                <span class="text-xs mb-2" data-en="Scroll" data-sw="Pita chini">Scroll</span>
                <div class="w-6 h-10 border-2 border-white/40 rounded-full flex justify-center pt-1">
    ...
    <section class="bg-gradient-to-r from-slate-900 to-slate-800 py-16">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div class="stat-counter p-6">
                    <div class="text-4xl font-bold text-light-blue mb-2">50+</div>
                    <div class="text-gray-300 font-medium">{{ __('messages.stat_years_label') }}</div>
                    <div class="text-gray-500 text-sm mt-1">{{ __('messages.stat_years_sub') }}</div>
                </div>
                <div class="stat-counter p-6">
                    <div class="text-4xl font-bold text-light-blue mb-2">500+</div>
                    <div class="text-gray-300 font-medium">{{ __('messages.stat_graduates_label') }}</div>
                    <div class="text-gray-500 text-sm mt-1">{{ __('messages.stat_graduates_sub') }}</div>
                </div>
                <div class="stat-counter p-6">
                    <div class="text-4xl font-bold text-light-blue mb-2">50+</div>
                    <div class="text-gray-300 font-medium">{{ __('messages.stat_partners_label') }}</div>
                    <div class="text-gray-500 text-sm mt-1">{{ __('messages.stat_partners_sub') }}</div>
                </div>
                <div class="stat-counter p-6">
                    <div class="text-4xl font-bold text-light-blue mb-2">7+</div>
                    <div class="text-gray-300 font-medium">{{ __('messages.stat_intl_label') }}</div>
                    <div class="text-gray-500 text-sm mt-1">{{ __('messages.stat_intl_sub') }}</div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col lg:flex-row items-center gap-12">
                <div class="lg:w-1/2 relative">
                    <img src="{{ asset('frontend_assets/img/mkuu.webp') }}" alt="mkuu wa chuo" 
                         class="relative rounded-2xl shadow-2xl w-full">
                    
                </div>
                <div class="lg:w-1/2">
                    <span class="text-light-blue font-semibold uppercase tracking-wider">{{ __('messages.principal_label') }}</span>
                    <h2 class="text-4xl font-bold mt-2 mb-6">{{ __('messages.principal_heading') }}</h2>
                    <p style="text-align: justify;" class="text-gray-600 mb-8 text-lg">{{ __('messages.principal_p1') }}</p>
                    <p style="text-align: justify;" class="text-gray-600 mb-8 text-lg">{{ __('messages.principal_p2') }}</p>
                    <p style="text-align: justify;" class="text-gray-600 mb-8 text-lg">{{ __('messages.principal_p3') }}</p>
                    <p class="text-gray-600 mb-2 text-lg font-semibold">{{ __('messages.principal_welcome') }}</p>
                    <p class="text-gray-600 text-lg">{{ __('messages.principal_name') }}</p>
                </div>
    ...
    <section id="Featured" class="py-20 bg-slate-50">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <span class="text-light-blue font-semibold uppercase tracking-wider">{{ __('messages.courses_section_label') }}</span>
                <h2 class="text-4xl font-bold mt-2 text-slate-800">{{ __('messages.courses_section_title') }}</h2>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    <div class="relative overflow-hidden">
                        <img src="{{ asset('frontend_assets/img/ufundimagari.webp') }}" alt="ufundi magari" class="w-full h-56 object-cover group-hover:scale-110 transition-transform duration-500">
                        <div class="absolute top-4 left-4 bg-light-blue text-white px-4 py-1.5 rounded-full text-sm font-semibold">{{ __('messages.dept_mechanic') }}</div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-slate-800 mb-2">{{ __('messages.dept_mechanic') }}</h3>
                        <p style="text-align: justify;" class="text-gray-500 mb-4">{{ __('messages.course_mechanic_desc') }}</p>
                        <a href="{{ route('frontend.ufundi-magari') }}" class="inline-flex items-center text-light-blue font-semibold group-hover:gap-3 gap-2 transition-all">
                ...
                <div class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    <div class="relative overflow-hidden">
                        <img src="{{ asset('frontend_assets/img/umememagari.webp') }}" alt="umeme magari" class="w-full h-56 object-cover group-hover:scale-110 transition-transform duration-500">
                        <div class="absolute top-4 left-4 bg-light-blue text-white px-4 py-1.5 rounded-full text-sm font-semibold">{{ __('messages.dept_auto_electrical') }}</div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-slate-800 mb-2">{{ __('messages.dept_auto_electrical') }}</h3>
                        <p style="text-align: justify;" class="text-gray-500 mb-4">{{ __('messages.course_auto_elec_desc') }}</p>
                        <a href="{{ route('frontend.umeme-magari') }}" class="inline-flex items-center text-light-blue font-semibold group-hover:gap-3 gap-2 transition-all">
                            {{ __('messages.view_details') }} <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    <div class="relative overflow-hidden">
                        <img src="{{ asset('frontend_assets/img/umememajumbani.webp') }}" alt="umememajumbani" class="w-full h-56 object-cover group-hover:scale-110 transition-transform duration-500">
                        <div class="absolute top-4 left-4 bg-ocean-blue text-white px-4 py-1.5 rounded-full text-sm font-semibold">{{ __('messages.dept_domestic_elec') }}</div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-slate-800 mb-2">{{ __('messages.dept_domestic_elec') }}</h3>
                        <p style="text-align: justify;" class="text-gray-500 mb-4">{{ __('messages.course_domestic_elec_desc') }}</p>
                        <a href="{{ route('frontend.umeme-majumbani') }}" class="inline-flex items-center text-light-blue font-semibold group-hover:gap-3 gap-2 transition-all">
                            {{ __('messages.view_details') }} <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    <div class="relative overflow-hidden">
                        <img src="{{ asset('frontend_assets/img/uchomeleaji.webp') }}" alt="uchomeleaji" class="w-full h-56 object-cover group-hover:scale-110 transition-transform duration-500">
                        <div class="absolute top-4 left-4 bg-emerald-500 text-white px-4 py-1.5 rounded-full text-sm font-semibold">{{ __('messages.dept_welding') }}</div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-slate-800 mb-2">{{ __('messages.dept_welding') }}</h3>
                        <p style="text-align: justify;" class="text-gray-500 mb-4">{{ __('messages.course_welding_desc') }}</p>
                        <a href="{{ route('frontend.uchomeleaji') }}" class="inline-flex items-center text-light-blue font-semibold group-hover:gap-3 gap-2 transition-all">
                            {{ __('messages.view_details') }} <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    <div class="relative overflow-hidden">
                        <img src="{{ asset('frontend_assets/img/ufundibomba.webp') }}" alt="ufundibomba" class="w-full h-56 object-cover group-hover:scale-110 transition-transform duration-500">
                        <div class="absolute top-4 left-4 bg-emerald-500 text-white px-4 py-1.5 rounded-full text-sm font-semibold">{{ __('messages.dept_plumbing') }}</div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-slate-800 mb-2">{{ __('messages.dept_plumbing') }}</h3>
                        <p style="text-align: justify;" class="text-gray-500 mb-4">{{ __('messages.course_plumbing_desc') }}</p>
                        <a href="{{ route('frontend.ufundi-bomba') }}" class="inline-flex items-center text-light-blue font-semibold group-hover:gap-3 gap-2 transition-all">
                            {{ __('messages.view_details') }} <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    <div class="relative overflow-hidden">
                        <img src="{{ asset('frontend_assets/img/ushonaji.webp') }}" alt="ushonaji" class="w-full h-56 object-cover group-hover:scale-110 transition-transform duration-500">
                        <div class="absolute top-4 left-4 bg-emerald-500 text-white px-4 py-1.5 rounded-full text-sm font-semibold">{{ __('messages.dept_tailoring') }}</div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-slate-800 mb-2">{{ __('messages.dept_tailoring') }}</h3>
                        <p style="text-align: justify;" class="text-gray-500 mb-4">{{ __('messages.course_tailoring_desc') }}</p>
                        <a href="{{ route('frontend.ushonaji') }}" class="inline-flex items-center text-light-blue font-semibold group-hover:gap-3 gap-2 transition-all">
                            {{ __('messages.view_details') }} <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    <div class="relative overflow-hidden">
                        <img src="{{ asset('frontend_assets/img/uashi.webp') }}" alt="uashi" class="w-full h-56 object-cover group-hover:scale-110 transition-transform duration-500">
                        <div class="absolute top-4 left-4 bg-emerald-500 text-white px-4 py-1.5 rounded-full text-sm font-semibold">{{ __('messages.dept_masonry') }}</div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-slate-800 mb-2">{{ __('messages.dept_masonry') }}</h3>
                        <p style="text-align: justify;" class="text-gray-500 mb-4">{{ __('messages.course_masonry_desc') }}</p>
                        <a href="{{ route('frontend.uashi') }}" class="inline-flex items-center text-light-blue font-semibold group-hover:gap-3 gap-2 transition-all">
                            {{ __('messages.view_details') }} <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    <div class="relative overflow-hidden">
                        <img src="{{ asset('frontend_assets/img/ict.webp') }}" alt="ICT" class="w-full h-56 object-cover group-hover:scale-110 transition-transform duration-500">
                        <div class="absolute top-4 left-4 bg-emerald-500 text-white px-4 py-1.5 rounded-full text-sm font-semibold">{{ __('messages.dept_ict') }}</div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-slate-800 mb-2">{{ __('messages.dept_ict') }}</h3>
                        <p style="text-align: justify;" class="text-gray-500 mb-4">{{ __('messages.course_ict_desc') }}</p>
                        <a href="{{ route('frontend.tehama') }}" class="inline-flex items-center text-light-blue font-semibold group-hover:gap-3 gap-2 transition-all">
                            {{ __('messages.view_details') }} <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    <div class="relative overflow-hidden">
                        <img src="{{ asset('frontend_assets/img/shortcourse.webp') }}" alt="shortcourse" class="w-full h-56 object-cover group-hover:scale-110 transition-transform duration-500">
                        <div class="absolute top-4 left-4 bg-emerald-500 text-white px-4 py-1.5 rounded-full text-sm font-semibold">{{ __('messages.short_course_badge') }}</div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-slate-800 mb-2">{{ __('messages.short_courses') }}</h3>
                        <p style="text-align: justify;" class="text-gray-500 mb-4">{{ __('messages.course_short_desc') }}</p>
                        <a href="{{ route('frontend.kozi-mfupi') }}" class="inline-flex items-center text-light-blue font-semibold group-hover:gap-3 gap-2 transition-all">
                            {{ __('messages.view_details') }} <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
    ...
    <section class="py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
        <div class="absolute inset-0 opacity-30">
            <div class="absolute top-0 left-0 w-96 h-96 bg-light-blue rounded-full filter blur-3xl"></div>
            <div class="absolute bottom-0 right-0 w-96 h-96 bg-ocean-blue rounded-full filter blur-3xl"></div>
        </div>
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                <span class="text-light-blue font-semibold uppercase tracking-wider">{{ __('messages.services_section_label') }}</span>
                <h2 class="text-4xl font-bold text-white mt-2 mb-6">{{ __('messages.services_section_title') }}</h2>
                <p class="text-gray-300 text-lg mb-12">{{ __('messages.principal_p3') }}</p>
                
                <div class="grid md:grid-cols-3 gap-6">
                    <!-- Mafunzo -->
                    <div class="bg-black/40 backdrop-blur-md p-8 rounded-2xl border-2 border-[#4ca8cd] hover:border-white/50 hover:scale-105 hover:shadow-[0_0_20px_rgba(76,168,205,0.3)] transition-all duration-300 group cursor-pointer">
                        <div class="w-20 h-20 bg-gradient-to-br from-[#4ca8cd] to-[#3a8eb0] rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:rotate-12 transition-transform duration-300">
                            <i class="fas fa-graduation-cap text-white text-3xl"></i>
                        </div>
                        <h3 class="text-2xl font-bold text-white mb-3 text-center">{{ __('messages.service_training_title') }}</h3>
                        <p class="text-gray-300 text-center leading-relaxed">{{ __('messages.service_training_body') }}</p>
                    </div>
                    ...
                    <div class="bg-black/40 backdrop-blur-md p-8 rounded-2xl border-2 border-[#4ca8cd] hover:border-white/50 hover:scale-105 hover:shadow-[0_0_20px_rgba(76,168,205,0.3)] transition-all duration-300 group cursor-pointer">
                        ...
                        <h3 class="text-2xl font-bold text-white mb-3 text-center">{{ __('messages.service_practical_title') }}</h3>
                        <p class="text-gray-300 text-center leading-relaxed">{{ __('messages.service_practical_body') }}</p>
                    </div>
                    ...
                    <div class="bg-black/40 backdrop-blur-md p-8 rounded-2xl border-2 border-[#4ca8cd] hover:border-white/50 hover:scale-105 hover:shadow-[0_0_20px_rgba(76,168,205,0.3)] transition-all duration-300 group cursor-pointer">
                        ...
                        <h3 class="text-2xl font-bold text-white mb-3 text-center">{{ __('messages.service_jobs_title') }}</h3>
                        <p class="text-gray-300 text-center leading-relaxed">{{ __('messages.service_jobs_body') }}</p>
                    </div>
                </div>
                
                <a href="{{ route('apply.start') }}" class="inline-flex items-center mt-12 bg-light-blue text-white px-8 py-4 rounded-lg font-semibold hover:bg-ocean-blue transition shadow-lg hover:shadow-xl">
                    {{ __('messages.service_learn_more') }} <i class="fas fa-arrow-right ml-2"></i>
                </a>
            </div>
        </div>
    </section>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <article class="news-card group">
                    ...
                    <h3 class="text-xl font-bold mt-2 mb-2 group-hover:text-light-blue transition">
                        <a href="https://whatsapp.com/channel/0029Vb7aWdOAojYs2eAC7T2U" target="_blank" class="inline-flex items-center font-semibold group-hover:gap-3 gap-2 transition-all">
                ...
                <article class="news-card group">
                    ...
                    <h3 class="text-xl font-bold mt-2 mb-2 group-hover:text-light-blue transition">
                        <a href="https://whatsapp.com/channel/0029Vb7LpfB42DcaKNTT713z" target="_blank" class="inline-flex items-center font-semibold group-hover:gap-3 gap-2 transition-all">
                ...
                <article class="news-card group">
                    ...
                    <p class="text-gray-600">{{ __('messages.news3_body') }}</p>
                </article>
            </div>
        </div>
    </section>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="{{ route('frontend.ushonaji') }}"        class="text-gray-400 hover:text-white transition">{{ __('messages.dept_tailoring') }}</a></li>
                        <li><a href="{{ route('frontend.uashi') }}"           class="text-gray-400 hover:text-white transition">{{ __('messages.dept_masonry') }}</a></li>
    ...
    <script>
        ...
        const translations = {
            ...
            sw: {
                ...
                heroDesc: "Mshirika wako wa kuthaminiwa kwa vyenzo vya kuunganisha,?? na kemikali za ujenzi Tanzania na Afrika Mashariki. Zaidi ya miaka 90 ya ubora wa kimataifa, sasa karibu nawe.",
                ...
                learnSustainability: "Jifu?? ya Uendelevu wetu",
                // Tools
